...
CREATE TABLE `users` (
  ...
  `admission_type` enum('NEW','TRANSFER') NOT NULL DEFAULT 'NEW',
  `doc_birth_cert` tinyint(1) NOT NULL DEFAULT '0',
  `doc_baptism_cert` tinyint(1) NOT NULL DEFAULT '0',
  `doc_transfer_letter` tinyint(1) NOT NULL DEFAULT '0',
  `doc_fhc_cert` tinyint(1) NOT NULL DEFAULT '0',
  `doc_birth_cert_url` varchar(500) DEFAULT NULL,
  `doc_baptism_cert_url` varchar(500) DEFAULT NULL,
  `doc_transfer_letter_url` varchar(500) DEFAULT NULL,
  `doc_fhc_cert_url` varchar(500) DEFAULT NULL,
