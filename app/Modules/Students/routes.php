...
$router->get('/students/partial', [StudentsController::class, 'partial'])->middleware('auth', 'perm:students.view');
...
$router->post('/students/{id}/status', [StudentsController::class, 'updateStatus'])->middleware('auth', 'csrf', 'perm:students.edit');
