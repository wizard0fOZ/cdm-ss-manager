    ...
    <div class="mx-auto max-w-6xl px-4 py-16">
      <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div class="fade-up">
          ...
          <h1 class="mt-5 font-display text-4xl font-extrabold tracking-tight md:text-6xl">Nurturing Faith, One Sunday at a Time</h1>
          <p class="mt-4 text-base text-slate-700 dark:text-slate-300">We guide children and teens through faith formation, fellowship, and structured catechesis across English, KUBM, Mandarin, Tamil, and RCIC programs.</p>
